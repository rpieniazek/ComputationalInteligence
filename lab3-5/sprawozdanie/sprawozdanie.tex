...
\minipage{0.32\textwidth}
  ...
  \caption{Metoda CG}\label{fig:CG}
\endminipage\hfill
\minipage{0.32\textwidth}%
  \includegraphics[width=\linewidth]{inc/results/zad3/HGA-bays29-tsp-method-L-BFGS-B-poptim-0-05-pressel-0-5}
  \caption{Metoda L}\label{fig:L}
\endminipage
\end{figure}


    \clearpage
	\subsection{Zmiana parametru prawdopodobieństwa}
...
\begin{figure}[!h]
   ...
   \includegraphics[width=3in]{{{inc/results/zad3/HGA-bays29-tsp-method-L-BFGS-B-poptim-0-85-pressel-0-5}}}\quad
    ...
    \clearpage
 	 \subsection{Zmiana parametru nacisku}
