...
\section{Funkcja Aluffi - Pentini}
	\subsection{Wzór analityczny}
	   \begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{inc/wzory/aluffi-pentini}
    ...
    \begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{inc/wzory/aluffini-pentini-global-minimum}
     \caption{Minimum globalne dla funkcji Aluffi - Pentini}
    \end{figure}
